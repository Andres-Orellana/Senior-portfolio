...
* Built a graphical Linux process monitor in C++ using SDL2 that reads live data from the `/proc` filesystem and renders a real-time, scrollable process table.
* Implemented CPU and memory tracking with color-coded indicators, sortable columns, and auto-refresh every 1.5 seconds.

[Memory Allocation Simulator](https://github.com/mill6141/os-memsim)
